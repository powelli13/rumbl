defmodule InfoSys do
  @moduledoc """
  Documentation for `InfoSys`. This application
  is used to answer questions. It will retrieve 
  information from various backends, cache the
  results and then return the best answer to
  the front end.
  """
